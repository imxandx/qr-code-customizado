...
function App() {
  ...
  const NavigateToPortfolio = () => {
    window.open("https://imxandx.github.io/portfolio");
  };
          ...
          >
            ...
            <Accordion sx={{ mt: 2, bgcolor: "#ffffff" }} defaultExpanded>
              <AccordionSummary
                ...
                id="panel1-header"
              >
                <Typography fontFamily={"System-ui"} variant="h5" sx={{ color: "#696969" }}>
                  Opções Principais
                </Typography>
              </AccordionSummary>
              <AccordionDetails>
          ...
          {url !== "" ? (
            ...
            >
              ...
              >
                ...
                <Button
                  variant="contained"
                  sx={{ width: "90%", mt: 1, mb: 2, backgroundColor: "#2d2e32", "&:hover": {backgroundColor: "#1d1e23",} }}
